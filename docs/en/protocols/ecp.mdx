...
description: How Flow Talk uses Ethereum Comments Protocol for user-owned, portable comments
---
...
1. **You write a post** on Flow Talk
2. **Flow Talk signs it** with your approval (gasless)
...
When alice.eth creates a post on Flow Talk:
- The post is stored onchain
- Other ECP apps instantly see it
- Even if Flow Talk shuts down, the post remains
- alice.eth always owns and controls her post

## Getting Started

Simply post on Flow Talk as usual. Behind the scenes, your posts are being stored on the blockchain through ECP.
