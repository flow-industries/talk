...
description: How Flow Talk uses Ethereum Follow Protocol to give you ownership of your social connections
---

import { Callout } from 'fumadocs-ui/components/callout';

# Your Social Graph on Flow Talk
...
## Why Flow Talk Chose EFP

### Interoperability
Build your network once on Flow Talk, use it on any other EFP-enabled app. Your followers automatically carry over.
...
If you're using Flow Talk, you're already building your social graph. Every follow is automatically recorded in EFP.
